...
\note{
  ...
  The figure here is an illustration of the most startingly result
  I've had in data cleaning: a genetics project where 25\% of the
...
\figh{Figs/dup_ids.pdf}{0.7}


\note{
   The nature major section concerns that you should go through and
   {\nhilit verify} all of the things that you know should be true.
...
\figh{Figs/check_calculations.pdf}{0.72}
...
\only<1|handout 0>{\figh{Figs/hypo_arrays.pdf}{0.75}}
\only<2|handout 0>{\figh{Figs/hypo_arrays_hilit.pdf}{0.75}}
\only<3|handout 0>{\figh{Figs/hypo_iqr_v_median.pdf}{0.75}}
\only<4>{\figh{Figs/hypo_boxplots.pdf}{0.75}}
