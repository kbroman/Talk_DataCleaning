...
\only<2>{
  ...
  \hspace{0.4\textwidth} {\color{background} 3.}
            {\principle and how it might be revealed} \hspace{20.5mm}
}
...
{\principle 5. Dates \& categories suck}
...
\vspace{-15mm} \hspace{0.4\textwidth}
{\principle 6. Check that distinct things are distinct}
...
\vspace{-15mm} \hspace{0.4\textwidth}
{\principle 7. Check that matching things match}
...
\vspace{-15mm} \hspace{0.4\textwidth}
{\principle 8. Check calculations}
...
{\principle 9. Look for other instances of a problem}
...
\vspace{-15mm} \hspace{0.4\textwidth}
{\principle 10. Make lots of plots}
...
\vspace{-15mm} \hspace{0.4\textwidth}
{\principle 11. Look at missing value patterns}
...
\vspace{-15mm} \hspace{0.4\textwidth}
       {\principle 12. With massive data,} \\
\hspace{0.4\textwidth} {\color{background} 12.} {\principle make more plots not fewer}
...
\vspace{-15mm} \hspace{0.4\textwidth}
{\principle 13. Follow up all artifacts}
...
\bbi
\item[14.] Ask questions
\item[15.] Ask for the primary data
\item[16.] Ask for metadata
\item[17.] Ask why data are missing
\ei
...
\bbi
\item[18.] Create checklists \& pipelines
\item[19.] Document not just what but why
\item[20.] Expect to recheck
\ei
