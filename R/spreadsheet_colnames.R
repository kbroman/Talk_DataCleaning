...
mat1 <- cbind(id=paste0("DO-", 221:230),
              ...
              "insulin.0"=c(0.74455, 0.70715, 1.1223, 0.4596, 0.76325,
                            0.53365, 0.04, 0.7097, 1.23145, 0.91375),
              "insulin.5"=c(2.0264, 1.1049, 2.1029, 0.4006, 0.8872,
                            0.823, 0.8618, 1.06785, 2.5124, 1.22935))

mat2 <- cbind(id=paste0("DO-", 321:330),
              "glucose.0"=
              ...
              "glucose.15"=
                  c(305.26214, 301.8201, 521.61894, 470.541525, 323.148455,
                    654.99799, 610.49733, 406.249135, 520.205245, 454.62209),
              "insulin.15"=c(0.04, 2.828, 1.02725, 0.8195, 0.40515,
                             1.07225, 0.4842, 0.2498, 0.8498, 1.7325))

pdf("../Figs/spreadsheet_colnames.pdf", height=5, width=11.3)
excel_fig(mat1, col_names=TRUE)
dev.off()

pdf("../Figs/spreadsheet_colnames2.pdf", height=5, width=11.3)
